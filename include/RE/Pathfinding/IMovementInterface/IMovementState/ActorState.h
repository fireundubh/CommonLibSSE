...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] bool IsMovingBack() const noexcept { return actorState1.movingBack; }
		[[nodiscard]] bool IsMovingForward() const noexcept { return actorState1.movingForward; }
		[[nodiscard]] bool IsMovingLeft() const noexcept { return actorState1.movingLeft; }
		[[nodiscard]] bool IsMovingRight() const noexcept { return actorState1.movingRight; }
