...
namespace RE
{
	...
	class VATSManager : public BSTSingletonSDM<VATSManager>
	{
	public:
		static VATSManager* GetSingleton();

		void SetGameTimeMult(float npcMult, float pcMult);
	...
	static_assert(sizeof(VATSManager) == 0xC0);
};