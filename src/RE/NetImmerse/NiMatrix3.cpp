...
namespace RE
{
	...
	{
		float sinX = std::sinf(a_point.x);
		float sinY = std::sinf(a_point.y);
		float sinZ = std::sinf(a_point.z);

		float cosX = std::cosf(a_point.x);
		float cosY = std::cosf(a_point.y);
		float cosZ = std::cosf(a_point.z);
